...
public class MainActivity extends AppCompatActivity {
    ...
    private void initBtns() {
        ...
        btn_my.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chooseVedio == 0){
                    chooseVedio = 1;//所有
                    btn_my.setText("all the videos");
                }
                else if(chooseVedio == 1)
                {
                    chooseVedio = 0;//我的
                    btn_my.setText("my video");
                }
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getString(R.string.select_an_image).equals(s)) {
                    //@TODO 1填充选择图片的功能
                    Toast.makeText(MainActivity.this,"select a cover",Toast.LENGTH_LONG)
                            .show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (resultCode == RESULT_OK && null != data) {
            ...
            {
                mSelectedVideo = data.getData();
                Toast.makeText(MainActivity.this,"Select a video",Toast.LENGTH_LONG)
                    .show();
                ...
                new Callback<PostVideoResponse>() {
                    ...
                    public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                        if (response.body() != null) {
                            Toast.makeText(MainActivity.this, "success！" +  response.body().toString(), Toast.LENGTH_SHORT)
                                    .show();
                            mBtnRefresh.callOnClick();
                        }
                        mBtn.setText(R.string.select_an_image);
