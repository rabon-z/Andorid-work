...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        animator2.setDuration(Integer.parseInt(durationSelector.getText().toString()));//durationSelector.getText().toString())
        animator2.setRepeatCount(ObjectAnimator.INFINITE);
        animator2.start();
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(target, "scaleY", 1, 2, 1);
        animator3.setDuration(Integer.parseInt(durationSelector.getText().toString()));//durationSelector.getText().toString())
